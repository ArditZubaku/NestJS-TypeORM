...
export class TestMigration1702700885386 implements MigrationInterface {
  name = 'TestMigration1702700885386';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "temporary_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "test" varchar NOT NULL, "test2" varchar NOT NULL)`,
    );
    await queryRunner.query(
